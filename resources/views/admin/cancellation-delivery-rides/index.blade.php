...
<div class="row">
    <div class="col-12">
        ...
        <div id="js-cancellation-delivery-partial-target">
            <include-fragment src="cancellation-delivery-rides/fetch">
...
<script>
    ...
    $('body').on('click', '.pagination a', function(e) {
        ...
        $.get(url, $('#search').serialize(), function(data){
            $('#js-cancellation-delivery-partial-target').html(data);
        });
    });
    ...
    $('#search').on('click', function(e){
        e.preventDefault();
            ...
            fetch('cancellation-delivery-rides/fetch?search='+search_keyword)
            .then(response => response.text())
            .then(html=>{
                document.querySelector('#js-cancellation-delivery-partial-target').innerHTML = html
            });
    });
     ...
     $('.filter,.resetfilter').on('click', function() {
                    ...
                    fetch('cancellation-delivery-rides/fetch?' + query)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-cancellation-delivery-partial-target').innerHTML = html
                        });
