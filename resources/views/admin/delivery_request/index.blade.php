        ...
        <div class="row">
            <div class="col-12">
                <div class="box">
                    ...
                    <div id="js-delivery-request-partial-target" class="table-responsive">
                        <include-fragment src="delivery-requests/fetch">
            ...
            $(function() {
                $('body').on('click', '.pagination a', function(e) {
                    ...
                    $.get(url, $('#search').serialize(), function(data) {
                        $('#js-delivery-request-partial-target').html(data);
                    });
                });
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('delivery-requests/fetch?search=' + search_keyword)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-delivery-request-partial-target').innerHTML = html
                        });
                });
                ...
                $('.filter,.resetfilter').on('click', function() {
                    ...
                    fetch('delivery-requests/fetch?' + query)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-delivery-request-partial-target').innerHTML = html
                        });
