                ...
                <div class="col-sm-12">
                    <div class="box">
                        ...
                        <div class="col-sm-12">
                            ...
                            <form method="post" class="form-horizontal" action="{{ url('notifications/push/send') }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="user">@lang('view_pages.user') <span
                                                    class="text-danger">*</span></label>
                                            <select name="user[]" id="user" class="form-control select2"
                                                multiple="multiple" data-placeholder="Select User">
                                    ...
                                    <div class="col-sm-2 mt-30">
                                        <div class="form-group">
                                            <input type="checkbox" id="all_user" name="all_user"
                                                class="filled-in chk-col-light-blue mt-4 selectAll" data-type="user" />
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="driver[]" id="driver" class="form-control select2"
                                                multiple="multiple" data-placeholder="Select Driver">
                                                {{-- <option value="" selected disabled>@lang('view_pages.select')</option> --}}
                                                @foreach ($drivers as $driver)
                                                    @if ($driver->user)
                                                        <option value="{{ $driver->id }}"
                                                            {{ old('driver') == $driver->id ? 'selected' : '' }}>
                                                            {{ ucfirst($driver->name) }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-2 mt-30">
                                        <div class="form-group">
                                            <input type="checkbox" id="all_driver" name="all_driver"
                                                class="filled-in chk-col-light-blue mt-4 selectAll" data-type="driver" />
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="title">@lang('view_pages.push_title') <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="message">@lang('view_pages.message') <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" name="message" id="message" rows="3"
                                                placeholder="@lang('view_pages.enter') @lang('view_pages.message')" required>{{ old('message') }}</textarea>
