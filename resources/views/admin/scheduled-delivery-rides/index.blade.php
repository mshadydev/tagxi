            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div id="js-request-partial-target" class="table-responsive">
                        <include-fragment src="scheduled-delivery-rides/fetch">
        ...
        <script>
            ...
            $(function() {
                ...
                $('#search').on('click', function(e) {
                    ...
                    fetch('scheduled-delivery-rides/fetch?search=' + search_keyword)
                ...
                $('.filter,.resetfilter').on('click', function() {
                    ...
                    fetch('scheduled-delivery-rides/fetch?' + query)
                        .then(response => response.text())
                        .then(html => {
                            document.querySelector('#js-request-partial-target').innerHTML = html
                        });
